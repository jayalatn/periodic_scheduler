...
void test_frequency()
{
    ...
    swap_task->setExecutionFrq(std::chrono::microseconds(1000));
    ...
    for(auto i = 0; i < 10000; ++i)
    {
        ...
        swap_task1->setExecutionFrq(std::chrono::microseconds(1000));
        swap_task1->setExecutionAt(swap_task->executeAt() + std::chrono::microseconds(0));
